...
```
travelokavn <command> [arguments] [flags]
```

Run `travelokavn <command> --help` for the full flag list on any command. This
...
per operation you declare in `travelokavn/domain.go`.
