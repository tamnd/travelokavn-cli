...
Most of these come down to network reality or how travelokavn serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

travelokavn rate-limits like any public site. travelokavn already paces
...
Where a surface is gated, travelokavn reads a cookie or token you supply
...
`travelokavn`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what travelokavn actually did
